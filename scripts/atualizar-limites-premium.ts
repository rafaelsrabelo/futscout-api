...
async function atualizarLimites() {
  ...
  console.log(`   monthlyLimitMatches: ${premiumPlan.monthlyLimitMatches ?? 'null'}`)
  console.log(`   monthlyLimitVideos: ${premiumPlan.monthlyLimitVideos ?? 'null'}`)
  console.log(
  ...
  console.log('💡 A API agora retornará os limites corretos!')
}
