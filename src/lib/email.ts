...
class EmailService {
  ...
  async sendPasswordResetCodeEmail(
    ...
    const html = `
      ...
      <head>
        <meta charset="utf-8">
        <title>Redefinição de Senha - FutScout</title>
        <style>
          body {
            font-family: Arial, sans-serif;
            line-height: 1.6;
      ...
      <body>
        ...
        <div class="content">
          ...
          <p>Recebemos um pedido para redefinir a senha da sua conta no FutScout. Utilize o código abaixo para continuar:</p>
          ...
          <p><strong>Instruções:</strong></p>
          <ul>
            <li>Digite este código na tela de redefinição de senha</li>
            <li>O código é válido por 15 minutos</li>
            <li>Não compartilhe este código com ninguém</li>
          </ul>
    ...
    return await this.sendEmail({
      to: email,
      subject: '🔐 Redefinição de Senha - FutScout',
      html,
      text,
    })
  }
